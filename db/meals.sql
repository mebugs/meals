...
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '权限集表' ROW_FORMAT = Dynamic;
...
INSERT INTO `sys_auth` VALUES (6, 'SYS-USER-P', '个人资料管理', 1, 2, 1, 2);
INSERT INTO `sys_auth` VALUES (7, 'SYS-ROLE', '角色管理', 2, 1, 1, 1);
INSERT INTO `sys_auth` VALUES (8, 'SYS-ROLE-V', '查看角色', 3, 7, 1, 2);
INSERT INTO `sys_auth` VALUES (9, 'SYS-ROLE-C', '创建角色', 1, 7, 1, 2);
INSERT INTO `sys_auth` VALUES (10, 'SYS-ROLE-M', '更新角色', 1, 7, 1, 2);
INSERT INTO `sys_auth` VALUES (11, 'SYS-AUTH', '权限集管理', 2, 1, 1, 1);
INSERT INTO `sys_auth` VALUES (12, 'SYS-AUTH-V', '查看权限集', 1, 11, 1, 2);
INSERT INTO `sys_auth` VALUES (13, 'SYS-AUTH-P', '个人权限集', 1, 11, 1, 2);
INSERT INTO `sys_auth` VALUES (14, 'DEV', '开发者能力', 1, -1, 1, 1);
INSERT INTO `sys_auth` VALUES (15, 'DEV-CODE', '代码生成', 2, 14, 1, 1);
INSERT INTO `sys_auth` VALUES (16, 'DEV-CODE-M', '代码生成操作', 1, 15, 1, 2);
...
INSERT INTO `sys_user` VALUES (2, 'test', '93C34BD6FB4290E96F22F2FF5A7978D4E7A445409ECBBB9D15B9C36832ECE379', '1dc84cbb-6ef8-4004-959b-9554dec54ea7', 1);
...
CREATE TABLE `sys_user_auth`  (
  ...
  `aid` bigint(20) NULL DEFAULT NULL COMMENT '授权ID',
  UNIQUE INDEX `UAID`(`uid`, `aid`) USING BTREE COMMENT '权限与用户唯一',
  INDEX `UID`(`uid`) USING BTREE COMMENT '查询索引'
